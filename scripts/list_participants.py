...
def participants_list(path, subject, session, abt):
    global selected_ids_dict, ch_excl_list, ylims, thr_peaks
    ref_num = 203
    ...
    # Mr Gerardo
        ...
        if session==0:
            ...
            date = ''
            selected_ids_dict = {'a_ce':1, 'a_oe':1, 'b_ce':2, 'b_oe':2,'c_ce':np.nan, 'c_oe':0}
            flag_notch = 0
            ylims = [0,30] ## dB for PSD visualization
            rows_plot = 2
            thr_peaks = 1.0
        ## read raw data
        raw_data = mne.io.read_raw_egi(path + fn_in, preload=True)
    ...
    # Mr Hamza
        ...
        title = 'P_'+str(subject)+'_rest_abt_geodesic_net_128'
        date = ''
        selected_ids_dict = {'a_ce':1, 'a_oe':0, 'b_ce':2, 'b_oe':2,'c_ce':np.nan, 'c_oe':0}
        flag_notch = 1
        rows_plot = 2
        ## read raw data
        raw_data = mne.io.read_raw_egi(path + fn_in, preload=True)
    ...
    # Mr Oussama
        ...
        title = 'P_'+str(subject)+'_rest_abt_geodesic_net_128'
        date = ''
        selected_ids_dict = {'a_ce':0, 'a_oe':0, 'b_ce':2, 'b_oe':2,'c_ce':np.nan, 'c_oe':0}
        flag_notch = 1
        rows_plot = 2
        ## read raw data
        raw_data = mne.io.read_raw_egi(path + fn_in, preload=True)
    ...
    # Mr Karim
        ...
        title = 'P_'+str(subject)+'_rest_abt_geodesic_net_128'
        date = ''
        selected_ids_dict = {'a_ce':0, 'a_oe':1, 'b_ce':1, 'b_oe':2,'c_ce':np.nan, 'c_oe':0}
        flag_notch = 1
        rows_plot = 2
        ## read raw data
        raw_data = mne.io.read_raw_egi(path + fn_in, preload=True)
    ...
    # neuro_002
        ...
        if session==0:
            ...
            title = 'P_'+str(subject)+'_rest_geodesic_net_128'
            Dx = 'AIS: A - NLI: L4'
            date = '48 days after trauma'
            selected_ids_dict = {'a_ce':0, 'a_oe':0, 'b_ce':np.nan, 'b_oe':np.nan,'c_ce':np.nan, 'c_oe':np.nan}
            flag_notch = 0
            # rows_plot = 1
            # fn_out = 'neuro_002_ann'1
            ## read raw data
        elif session==1:
            ...
            title = 'P_'+str(subject)+'_rest_geodesic_net_128'
            Dx = 'AIS: A - NLI: L4'
            date = '254 days after trauma'
            selected_ids_dict = {'a_ce':2, 'a_oe':2, 'b_ce':2, 'b_oe':1,'c_ce':np.nan, 'c_oe':0}
            flag_notch = 0
            # rows_plot = 1
            # fn_out = 'neuro_002_ann'
            ## read raw data
    ...
    # neuro_003
        ...
        if session==0:
            ## hospital regular room. Patient on bed. We had difficulties placing the patient in the bike. Data highly affected by artefacts.
            fn_in = 'session_'+str(session)+'/'+'neuro_003_20221231_080823.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: C - NLI: C5'
            date = '33 days after trauma'
            ...
            Dx = 'AIS: C - NLI: C6'
            date = '103 days after trauma'
            selected_ids_dict = {'a_ce':0, 'a_oe':1, 'b_ce':np.nan, 'b_oe':np.nan,'c_ce':np.nan, 'c_oe':np.nan}
            flag_notch = 1
            # rows_plot = 1
        elif session==2:
            ...
            title = 'P_'+str(subject)+'_rest_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: C - NLI: C6'
            date = '301 days after trauma'
            selected_ids_dict = {'a_ce':2, 'a_oe':2, 'b_ce':np.nan, 'b_oe':np.nan,'c_ce':np.nan, 'c_oe':np.nan}
            flag_notch = 1
            # rows_plot = 1
        else:
            pass
    ...
    # neuro_005
        ...
        if session==0:
            ...
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'
            Dx = 'AIS: D - NLI: C7'
            date = '390 days after trauma'
            # selected_ids_dict = {'a_ce':0, 'a_oe':0, 'b_ce':2, 'b_oe':1,'c_ce':0, 'c_oe':0}
            selected_ids_dict = {'a_ce':2, 'a_oe':2, 'b_ce':1, 'b_oe':1,'c_ce':0, 'c_oe':0}
            flag_notch = 0
            # rows_plot = 2
    ...
    # neuro_006
        ...
        # info_p = 'M, 55 y'
        info_p = f"ID: {str(subject).zfill(2)}, Sex: M, Age: 55 y"
        ...
        if session==0:
            ...
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C5'
            date = '26 days after trauma'
            selected_ids_dict = {'a_ce':0, 'a_oe':2, 'b_ce':2, 'b_oe':2,'c_ce':np.nan, 'c_oe':np.nan}
            flag_notch = 0
            # rows_plot = 2
        elif session==1:
            ...
            title = 'P_'+str(subject)+'_rest_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C6'
            date = '88 days after trauma'
            selected_ids_dict = {'a_ce':2, 'a_oe':1, 'b_ce':np.nan, 'b_oe':np.nan,'c_ce':np.nan, 'c_oe':np.nan}
            flag_notch = 0
            # rows_plot = 1
        ## read raw data
        raw_data = mne.io.read_raw_egi(path + fn_in, preload=True)
    ...
    # neuro_007
        ...
        if session==0:
            ...
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: B - NLI: C6'
            date = '17 days after trauma'
            # selected_ids_dict = {'a_ce':1, 'a_oe':0, 'b_ce':2, 'b_oe':1,'c_ce':np.nan, 'c_oe':np.nan}
            selected_ids_dict = {'a_ce':1, 'a_oe':0, 'b_ce':1, 'b_oe':1,'c_ce':np.nan, 'c_oe':np.nan}
            flag_notch = 0
        elif session==1:
            ## 15 Apr, 2025
    ...
    # neuro_008
        ...
        if session==0:
            ...
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C4'
            date = '20 days after trauma'
            selected_ids_dict = {'a_ce':2, 'a_oe':1, 'b_ce':2, 'b_oe':2,'c_ce':np.nan, 'c_oe':np.nan}
            flag_notch = 0
            # rows_plot = 2
        else:
            fn_in = ''
    ...
    # neuro_009
        ...
        if session==0:
            ...
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            date = '16 days after trauma'
            Dx = 'AIS: D - NLI: T1'
            selected_ids_dict = {'a_ce':0, 'a_oe':0, 'b_ce':2, 'b_oe':1,'c_ce':np.nan, 'c_oe':np.nan}
            # Dx = 'D - C1'
            flag_notch = 0
            ylims = [5, 35] ## PSD plot y-limits
            thr_peaks = 3.75
        elif session==1:
            ## date of data acquisition: Aug 13, 2025
            fn_in = 'session_'+str(session)+'/'+'neuro_009_suivi_3m_20250813_102909.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            date = '112 days after trauma'
            Dx = 'AIS: E - NLI: T1'
            selected_ids_dict = {'a_ce':1, 'a_oe':1, 'b_ce':2, 'b_oe':2,'c_ce':np.nan, 'c_oe':np.nan}
            # Dx = 'D - C1'
            flag_notch = 0
        elif session==2:
            ## date of data acquisition: Oct 20, 2025
            ## in the lab with the iMac
            fn_in = 'session_'+str(session)+'/'+'Neuro-009- session suivi 6 mois _20251020_101357.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            date = '180 days after trauma'
            Dx = 'AIS: E - NLI: T1'
    ...
    # neuro_011
        ...
        if session==0:
            ...
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: A - NLI: T5'
            date = '15 days after trauma'
            flag_notch = 0
            # rows_plot = 2
            selected_ids_dict = {'a_ce':2, 'a_oe':0, 'b_ce':2, 'b_oe':2,'c_ce':np.nan, 'c_oe':np.nan}
        else:
            print(f"Data from session {session} did not find.")
            return 0
        # fn_out = 'neuro_007_ann'
    ...
    # neuro_012
        ...
        if session==0:
            ...
            ## patient able to move his legs, however, he came in an wheel chair (electric)
            fn_in = 'session_'+str(session)+'/'+'Neuro_012_sesssion_6m_20260227_110552.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C5'
            date = '249 days after trauma'
            selected_ids_dict = {'a_ce':0, 'a_oe':0, 'b_ce':2, 'b_oe':1,'c_ce':0, 'c_oe':0}
            flag_notch = 0
            # rows_plot = 2
        else:
    ...
    # neuro_013
        ...
        ####
        if session==0:
            ## date data acquisition July 21, 2025
            ## I think it was in the soins intermediaire, patient able to walk, probably the same day of his congé
            fn_in = 'session_'+str(session)+'/'+'neuro_013_20230114_193005.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C5'
            date = '7 days after trauma'
            selected_ids_dict = {'a_ce':0, 'a_oe':0, 'b_ce':2, 'b_oe':2,'c_ce':np.nan, 'c_oe':np.nan}
            flag_notch = 0
            # rows_plot = 2
        ####
    ...
    # neuro_014
        ...
        if session==0:
            ...
            ## acquisition date: July 25, 2025
            fn_in = 'session_'+str(session)+'/'+'neuro_014_20250725_141440.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C1'
            date = '12 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':0, 'a_oe':0, 'b_ce':1, 'b_oe':2,'c_ce':np.nan, 'c_oe':np.nan}
            # rows_plot = 2
        elif session==1:
            ...
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C1'
            date = '96 days after trauma'
            flag_notch = 1
            selected_ids_dict = {'a_ce':0, 'a_oe':2, 'b_ce':1, 'b_oe':1,'c_ce':np.nan, 'c_oe':0}
            # rows_plot = 2
        elif session==2:
    ...
    ## F, 
        ...
        if session==0:
            ...
            ## lab, wheelchair, unable to walk but with legs mobility
            ## wed, Aug 5 pm, iMac
            fn_in = 'session_'+str(session)+'/'+'Neuro_018_6mois_20260805_165419.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = f"to verify: ['AIS: C - NLI: C6']"
            date = '326 days after trauma'
            flag_notch = 0
    ...
    # neuro_019
        ...
        if session==0:
            ...
            date = '14 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':0, 'a_oe':1, 'b_ce':0, 'b_oe':1,'c_ce':np.nan, 'c_oe':0}
            # rows_plot = 2
        else:
            print(f"Data from session {session} did not find.")
            return 0
    ...
    # neuro_020
        ...
        info_p = f"ID: {str(subject).zfill(2)}, Sex: M, Age: 80 y"
        ...
        ####
            ...
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C4'
            date = '135 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':1, 'a_oe':1, 'b_ce':2, 'b_oe':2,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ####
        elif session==2:
            ## Thu, April 16, 2026, in the lab with the macbook (geodesic)
            ## participant able to walk, but with limited mobility of his right arm
            fn_in = 'session_'+str(session)+'/'+'Neuro_020_6mois_20260416_113626.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif',''] 
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C4'
            date = '221 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':0, 'a_oe':0, 'b_ce':2, 'b_oe':2,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ####
    ...
    # neuro_022
        ...
        if session==0:
            ...
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C4'
            date = '46 days after trauma'
            flag_notch = 1
            selected_ids_dict = {'a_ce':1, 'a_oe':0, 'b_ce':1, 'b_oe':0,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        elif session==2:
            ...
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C6'
            date = '118 days after trauma'
            flag_notch = 1
            selected_ids_dict = {'a_ce':0, 'a_oe':0, 'b_ce':2, 'b_oe':2,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        elif session==3:
            ## session June 26, 2026, 11h50 in the lab, with the iMac large screen
            ## patient able to walk; he sit blue chair
            fn_in = 'session_'+str(session)+'/'+'Neuro_22_Wa_6mois_20260626_114628.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: E'
            date = '267 days after trauma'
            flag_notch = 1
            # selected_ids_dict = {'a_ce':0, 'a_oe':0, 'b_ce':2, 'b_oe':2,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        else:
    ...
    # neuro_023
        ...
        if session==0:
            ...
            date = '20 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':0, 'a_oe':1, 'b_ce':2, 'b_oe':1,'c_ce':np.nan, 'c_oe':np.nan}
            # rows_plot = 2
        ####
        elif session==1:
    ...
    # neuro_024
        ...
        if session==0:
            ...
            date = '10 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':0, 'a_oe':1, 'b_ce':2, 'b_oe':2,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        else:
            print(f"Data from session {session} did not find.")
            return 0
    ...
    # neuro_025
        ...
        info_p = f"ID: {str(subject).zfill(2)}, Sex: F, Age: 21 y"
    ...
    # neuro_027
        ...
        # info_p = 'M, 70y'
        info_p = f"ID: {str(subject).zfill(2)}, Sex: M, Age: 70 y"
        ...
        ###
            ...
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C5'
            date = '75 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':1, 'a_oe':1, 'b_ce':2, 'b_oe':2,'c_ce':0, 'c_oe':0}
            rows_plot = 2
        ###
        elif session==2:
            ## session 3 mois, Monday, May 4, 2026, 15h00 in CIT lab, in a e-wheelchair, iMac (big screen)
            ## patient able to move his legs, he could make pressure to push the bike but it was adviced that be relax and do not push during all the session
            ## E123 not working
            fn_in = 'session_'+str(session)+'/'+'Neuro_027_StD_seance_03_20260504_041331.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: C - NLI: C5'
            date = '183 days after trauma'
    ...
    # neuro_028
        ...
        ###
            ...
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: T1'
            date = '57 days after trauma'
            flag_notch = 1
            # selected_ids_dict = {'a_ce':0, 'a_oe':0, 'b_ce':2, 'b_oe':2,'c_ce':0, 'c_oe':0}
            rows_plot = 2
        elif session==2:
            ## session 6 months, Fri, July 20, 2026, 16h30 in lab CIT, on the blue chair, iMac
            fn_in = 'session_'+str(session)+'/'+'Neuro_028_20260720_164154.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'To confirm [AIS: D - NLI: T1]'
            date = '242 days after trauma'
            flag_notch = 1
            # selected_ids_dict = {'a_ce':0, 'a_oe':0, 'b_ce':2, 'b_oe':2,'c_ce':0, 'c_oe':0}
            rows_plot = 2
        ###
    ...
    # neuro_030
        ...
        if session==0:
            ...
            Dx = 'AIS: D - NLI: T4'
            date = '2 w postop'
            # selected_ids_dict = {'a_ce':0, 'a_oe':2, 'b_ce':2, 'b_oe':1,'c_ce':0, 'c_oe':0}
            rows_plot = 2
        elif session==1:
            ...
            ## session Monday, April 27, 2026, lab, blue chair
            ## patient able to walk; hair voluminous, which has restrain some scalp-electrodes' contact
            ## afternoon after a long clinic day
            fn_in = 'session_'+str(session)+'/'+'Neuro_030_seance_3_20260427_043637.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: L4'
            # selected_ids_dict = {'a_ce':0, 'a_oe':2, 'b_ce':2, 'b_oe':1,'c_ce':0, 'c_oe':0}
    ...
    # neuro_031
        ...
        if session==0:
            ...
            ## session Monday, March 23, 2026 in CIT Lab, macbook, in the blue dentist chair
            ## patient came on a wheelchair 
            ## She is in a rahabilitation program
            ## I observed strength in her arms but not voluntary legs mobility. 
            fn_in = 'session_'+str(session)+'/'+'neuro031_CT_3mois_20260323_140448.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: C - NLI: L1'
            date = '96 days after trauma'
            ...
            ## session Monday, July 6, 2026 in CIT Lab, iMac (large screen), on bed semi-sitting position
            ## patient came on a wheelchair 
            ## I observed strength in her arms but very limited mobility in her legs 
            fn_in = 'session_'+str(session)+'/'+'neuro_031_th_6mois_20260706_123744.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: C - NLI: L3'
            date = '201 days after trauma'
            flag_notch = 1
            selected_ids_dict = {'a_ce':0, 'a_oe':1, 'b_ce':2, 'b_oe':1,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ###
        else:
            print(f"Data from session {session} did not find.")
    ...
    # neuro_032
        ...
        if session==0:
            ...
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C4'
            date = '9 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':1, 'a_oe':1, 'b_ce':1, 'b_oe':1,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        elif session==1:
            ## session on Monday, March 09, 2026, 13h30, in the CIT lab, macbook
            ## patient able to walk. Test on the blue chair (dentist's chair)
            ## Electrode E123 did not work
            fn_in = 'session_'+str(session)+'/'+'neuro_32_KV_6sem_20260309_135907.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C5'
            date = '51 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':1, 'a_oe':2, 'b_ce':1, 'b_oe':1,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ###
        else:
            print(f"Data from session {session} did not find.")
    ...
    # neuro_033
        ...
        if session==0:
            ...
            ## 
            fn_in = 'session_'+str(session)+'/'+'Neuro033_session_2_20260408_124423.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: B - NLI: T10'
            date = '73 days after trauma'
            flag_notch = 1
            selected_ids_dict = {'a_ce':1, 'a_oe':2, 'b_ce':2, 'b_oe':1,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ###
        else:   
            print(f"Data from session {session} did not find.")
    ...
    # neuro_034
        ...
        if session==0:
            ...
            date = '8 days after trauma'
            flag_notch = 1
            selected_ids_dict = {'a_ce':2, 'a_oe':1, 'b_ce':1, 'b_oe':0,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        elif session==1:
            ## 
            fn_in = 'session_'+str(session)+'/'+'Neuro_034_MG_seance_2_20260423_032426.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: C - NLI: T8'
            date = '79 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':1, 'a_oe':2, 'b_ce':1, 'b_oe':2,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ###
        else:   
            print(f"Data from session {session} did not find.")
    ...
    # neuro_036
        ...
        ##
        if session==0:
            ## session in a regular and individual hospital room, on the bed, with cycling, March 09, 2026, macbook
            ## unable to move his legs
            fn_in = 'session_'+str(session)+'/'+'Neuro_036seance1_20260313_114953.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: B - NLI: C3'
            date = '48 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':0, 'a_oe':1, 'b_ce':1, 'b_oe':2,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ###
        elif session==1:
            ## session during a follow-up clinic extern (sous-sol) in a former operation-room, on bed, with cycling, July 16, 2026, iMac (large screen)
            ## limited physical mobility (unable to move his legs)
            fn_in = 'session_'+str(session)+'/'+'neuro_036_Gas_16_juillet_2026_20260716_130029.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS:  - NLI: '
            date = '48 days after trauma'
    ...
    # neuro_037
        ...
        ##
        if session==0:
            ## hospitalized patient stable, wheelchair, right arm and right leg with more power than those of the left side.
            ## session in the CIT lab, afternoon 3pm, with macbook
            ## 
            fn_in = 'session_'+str(session)+'/'+'neuro_037_premiere_seance_20260331_151218.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: C - NLI: C5'
            date = '32 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':2, 'a_oe':3, 'b_ce':2, 'b_oe':1,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ###
        else:   
            print(f"Data from session {session} did not find.")
    ...
    # neuro_038
        ...
        info_p = f"ID: {str(subject).zfill(2)}, Sex: M, Age: 83 y"
        path = path + 'a_neuroplasticity/n_038/'
        ##
        if session==0:
            ## 
            fn_in = 'session_'+str(session)+'/'+'Neuro_38_Ro_session_1_20260410_042036.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C5'
            date = '14 days after trauma'
    ...
    # neuro_039
        ...
        info_p = f"ID: {str(subject).zfill(2)}, Sex: M, Age: 75 y"
        path = path + 'a_neuroplasticity/n_039/'
        ##
        if session==0:
            ## hospitalized patient soins intermediaires (a machine helps him to breating and with a catether that probably was used to give him food), in bed, with some strenght in his legs.
            ## session in the morning, patient in a wheelchair, with macbook, April 21, 2026
            ## 
            fn_in = 'session_'+str(session)+'/'+'Neuro_039_premiere_seance_20260421_130110.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: B - NLI: C2'
            date = '17 days after trauma'
    ...
    # neuro_040
        ...
        info_p = f"ID: {str(subject).zfill(2)}, Sex: M, Age: 63 y"
        path = path + 'a_neuroplasticity/n_040/'
        ##
        if session==0:
            ## hospitalized soins intensives (patient stable), in bed, with some strenght in his legs.
            ## session in the afternoon 2pm, with macbook, April 17, 2026
            ## 
            fn_in = 'session_'+str(session)+'/'+'neuro_40_session_1_2026.04.17_20260417_144105.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C3'
            date = '3 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':1, 'a_oe':0, 'b_ce':1, 'b_oe':1,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ##
        elif session==1:
            ## patient hospitalized but stable and with some strenght in his legs.
            ## session in the afternoon 3pm, in the  CIT lab, in a wheelchair, after session velo with iMac, April 30, 2026. He applied efforts to pedaling. I noticed signs of fatigue and some discomfort.
            ## 
            fn_in = 'session_'+str(session)+'/'+'neuro_040_seance_02_20260430_152835.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C4'
            date = '16 days after trauma'
            flag_notch = 0
            ## selected segments june 15, 2026
            selected_ids_dict = {'a_ce':0, 'a_oe':0, 'b_ce':2, 'b_oe':1,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ###
        else:   
...
############################
    # neuro_041
        ...
        info_p = f"ID: {str(subject).zfill(2)}, Sex: M, Age: 82 y"
        path = path + 'a_neuroplasticity/n_041/'
        ##
        if session==0:
            ## hospitalized in soins intensives (patient with traqueotomy and ventilatory assistance), in wheelchair.
            ## session in the afternoon 2pm, with macbook, April 17, 2026
            ## 
            fn_in = 'session_'+str(session)+'/'+'neuro041_20260428_010258.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: A - NLI: C5'
            date = '8 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':2, 'a_oe':3, 'b_ce':2, 'b_oe':0,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ###
        else:   
            print(f"Data from session {session} did not find.")
...
############################
    # neuro_042
        ...
        info_p = f"ID: {str(subject).zfill(2)}, Sex: M, Age: 48 y"
        path = path + 'a_neuroplasticity/n_042/'
        ##
        if session==0:
            ## hospitalized in a regular room (patient stable), in bed because his wheelchair was not working properly.
            ## session at 10 am, with macbook, friday june 05, 2026.
            ## His initial diagnosis was AIS A or B, NLI C3. 
            ## At the moment of first session of EEG, he has gained strength to move his hands and his legs. He could pedaling by himself. 
            ## Patient speak often during the session, which probably add artifacts to the EEG data.
            ## Last resting state was not recorded due to patient discomfort
            ## 
            fn_in = 'session_'+str(session)+'/'+'Neuro_042_Br_seance_1_20260605_095106.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: B/C - NLI: C3'
            date = '26 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':1, 'a_oe':0, 'b_ce':2, 'b_oe':2,'c_ce':np.nan, 'c_oe':np.nan}
            # rows_plot = 2
        ###
        else:   
            print(f"Data from session {session} did not find.")
    ...
    # neuro_043
        ...
        info_p = f"ID: {str(subject).zfill(2)}, Sex: M, Age: 69 y"
        path = path + 'a_neuroplasticity/n_043/'
        ##
        if session==0:
            ## soins intermediaire, fauteuil roulant
            ## may 06, 2026
            fn_in = 'session_'+str(session)+'/'+'Neuro_043_Led_premiere_seance_20260506_123748.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: C - NLI: C4'
            date = '25 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':1, 'a_oe':1, 'b_ce':1, 'b_oe':3,'c_ce':0, 'c_oe':0}
            
        ###
        elif session==1:
            ## lab CIT, fauteuil roulant
            ## may 28, 2026, 3pm
            fn_in = 'session_'+str(session)+'/'+'neuro_043_session_2_20260528_145500.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: C - NLI: C4'
            date = '47 days after trauma'
            flag_notch = 0
            selected_ids_dict = {'a_ce':0, 'a_oe':1, 'b_ce':0, 'b_oe':0,'c_ce':0, 'c_oe':0}
        ###
        elif session==2:
            ## lab CIT, fauteuil roulant
            ## juin 29, 2026, 12h (midi)
            ## patient has some strengh in his legs to slowly pedaling by himself
            fn_in = 'session_'+str(session)+'/'+'neuro_043_3mois_2026_06_29_20260629_124813.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: C - NLI: C4'
            date = '79 days after trauma'
...
############################
    # neuro_044
        ...
        info_p = f"ID: {str(subject).zfill(2)}, Sex: M, Age: 22 y"
        path = path + 'a_neuroplasticity/n_044/'
        ##
        if session==0:
            ## hospitalized in soins intensives (patient stable), in bed.
            ## session in the afternoon 3pm, with iMac (big screen), May 13, 2026
            ## patient had difficulties to keep eyes open due to an injury to his eyes
            ## he was feeling pain in the back of the head because the electrodes were pressing the region of the injury at the back of his head
            fn_in = 'session_'+str(session)+'/'+'Neuro_044_Ra_seance_1_20260513_035100.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: A - NLI: C4'
            date = '5 days after trauma'
            flag_notch = 1
            selected_ids_dict = {'a_ce':2, 'a_oe':2, 'b_ce':2, 'b_oe':2,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ###
        else:   
            print(f"Data from session {session} did not find.")
    ...
    # neuro_045
        ...
        info_p = f"ID: {str(subject).zfill(2)}, Sex: F, Age: 86 y"
        path = path + 'a_neuroplasticity/n_045/'
        ##
        if session==0:
            ## hospitalized in soins intensives (patient stable), in bed.
            ## session in the afternoon 3pm, with iMac (big screen), June 12, 2026
            ## patient had difficulties to keep a normal level of oxigen during cycling.
            ## oxygen support was provided to the patient
            ## we adjusted the bike's pedals to small legs lengths. We inclined the bed to reduce pressure from the legs to the abdomen. We set a minimum bike speed that was increased gradually to avoid patient's short of oxigen.
            ## 
            fn_in = 'session_'+str(session)+'/'+'Neuro_045 Session 1_20260612_025211.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C2'
            date = '5 days after trauma'
            flag_notch = 1
            ch_excl_list.append('E123')
            selected_ids_dict = {'a_ce':0, 'a_oe':0, 'b_ce':1, 'b_oe':2,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ###
        else:   
            print(f"Data from session {session} did not find.")
    ...
    # neuro_046
        ...
        info_p = f"ID: {str(subject).zfill(2)}, Sex: M, Age: 56 y"
        path = path + 'a_neuroplasticity/n_046/'
        ##
        if session==0:
            ## hospitalized in soins intermed. (patient stable), in bed.
            ## session in the afternoon 2pm, with iMac (big screen), June 19, 2026
            ## patient with oxygen support
            ## we adjusted the bike's pedals to small legs lengths.
            ## 
            fn_in = 'session_'+str(session)+'/'+'neuro046_Gi_seace1_20260619_143804.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: C - NLI: T12'
            date = '7 days after trauma'
            ...
            ## hospitalized in regular room before discharge (patient stable), in bed.
            ## session in the afternoon 4pm, with iMac (big screen), July 8, 2026
            ## patient in good condition and good mood. He has been improved
            fn_in = 'session_'+str(session)+'/'+'neuro_046_Gir_08_julliet_2026_20260708_161946.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: L1'
            date = '26 days after trauma'
            ...
            ## visit for a session of photography with the fundation HSCM. Wheelchair but with strength in his legs.
            ## session in the afternoon 4pm, with iMac (big screen), Aug 4, 2026 in the lab
            ## patient in good condition and good mood. He has been improved
            fn_in = 'session_'+str(session)+'/'+'neuro_046_jm_4aout2026_20260804_151709.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = f"to confirm: ['AIS: D - NLI: L1']"
            date = '53 days after trauma'
            flag_notch = 1
            # ch_excl_list.append('E123')
            selected_ids_dict = {'a_ce':1, 'a_oe':1, 'b_ce':2, 'b_oe':2,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ###
            ...
            print(f"Data from session {session} were not found.")
            return 0
        ## read raw data
        raw_data = mne.io.read_raw_egi(path + fn_in, preload=True)
        acquisition_system = 'geodesic'
    ...
    # neuro_047
        ...
        info_p = f"ID: {str(subject).zfill(2)}, Sex: M, Age: 48 y"
        path = path + 'a_neuroplasticity/n_047/'
        ##
        if session==0:
            ## hospitalized in soins intermed. (patient stable), in bed.
            ## session in the morning 11am, with iMac (big screen), June 30, 2026
            ## He likes bike-pedaling. Recent haircut
            ## 
            fn_in = 'session_'+str(session)+'/'+'Neuro_047_Char_30_juin_2026_20260630_113148.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: D - NLI: C4'
            date = '13 days after trauma'
            flag_notch = 1
            # ch_excl_list.append('E123')
            selected_ids_dict = {'a_ce':1, 'a_oe':1, 'b_ce':1, 'b_oe':2,'c_ce':0, 'c_oe':0}
            # rows_plot = 2
        ###
        else:   
            print(f"Data from session {session} did not find.")
    ...
    # neuro_048
        ...
        info_p = f"ID: {str(subject).zfill(2)}, Sex: M, Age: 20 y"
        path = path + 'a_neuroplasticity/n_048/'
        ##
        if session==0:
            ## hospitalized in soins intermed. (patient stable), in (wheel)chair.
            ## session in the morning 11am, with iMac (big screen), July 09, 2026
            ## Severe SCI lesion, young adult, with tracheotomy 
            fn_in = 'session_'+str(session)+'/'+'Neuro_48_trud_2026_07_09_seance-1_20260709_111251.mff'
            fn_csv = ['session_'+str(session)+'/'+'annotations.fif','']
            title = 'P_'+str(subject)+'_rest_and_ABT_geodesic_net_128'+' session_'+str(session)
            Dx = 'AIS: A - NLI: C4'
            date = '27 days after trauma'
            ...
            ch_excl_list.append('E123')
            selected_ids_dict = {'a_ce':1, 'a_oe':1, 'b_ce':2, 'b_oe':2,'c_ce':0, 'c_oe':0}
            ylims = [0,30] ## dB for data visualization
            # rows_plot = 2
        ###
        else:   
            print(f"Data from session {session} did not find.")
    ...
    return path, fn_in, fn_csv, raw_data, title, flag_notch, acquisition_system, info_p, Dx, selected_ids_dict, ch_excl_list, ylims, thr_peaks